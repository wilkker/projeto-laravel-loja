    ...
    public function up(): void
    {
        ...
        Schema::create('regra_user', function (Blueprint $table) {
            ...
            //chave estrangeira de usuário
             ...
             $table->foreign('id_user')->references('id')->on('users');//configuração da chave estrangeira
             
             // chave estrangeira de categorias
             $table->unsignedBigInteger('id_regra');
             $table->foreign('id_regra')->references('id')->on('regras');//configuração da chave estrangeira
